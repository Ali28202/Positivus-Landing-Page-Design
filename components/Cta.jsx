export default function CTA() {
	return (
		<>
			<div className="flex items-center justify-center xl:py-24 py-14">
				<div className="xl:w-[80%] w-[90%] xl:px-16 xl:py-14 px-10 py-10 bg-[#f3f3f3] rounded-[30px] flex items-center justify-between">
					<div className="flex flex-col gap-8 w-[26rem]">
						...
						<button className="bg-[#191a23] text-white rounded-xl py-4 xl:w-64 w-full hover:bg-[#b9ff66] border-[1px] border-black hover:text-black duration-300">
